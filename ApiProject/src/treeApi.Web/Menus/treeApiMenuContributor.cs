...
namespace treeApi.Web.Menus;

public class treeApiMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<treeApiResource>();
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                treeApiMenus.HostDashboard,
                l["Menu:Dashboard"],
                "~/HostDashboard",
                icon: "fa fa-line-chart",
                order: 2
            ).RequirePermissions(treeApiPermissions.Dashboard.Host)
        );

        //TenantDashboard
        context.Menu.AddItem(
            new ApplicationMenuItem(
                treeApiMenus.TenantDashboard,
                l["Menu:Dashboard"],
                "~/Dashboard",
                icon: "fa fa-line-chart",
                order: 2
            ).RequirePermissions(treeApiPermissions.Dashboard.Tenant)
        );
